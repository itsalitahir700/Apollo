...
function Role() {
    ...
    return (
        <div>
            ...
            <RoleData editRow={editRow} roleData={roleData} viewDetails={viewDetails} />

            <Dialog header="Add Role" visible={displayBasic} style={{ width: "80%" }} onHide={() => setDisplayBasic(!displayBasic)}>
