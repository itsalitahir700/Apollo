    ...
    return (
        <div>
            <div className="p-fluid p-formgrid p-grid">
                ...
                <div className="p-field p-col-12 p-md-3 p-d-flex p-mt-4 p-pl-6">
                    <Checkbox
                        disabled={viewmode}
                        value="Y"
                        onChange={(e) => {
                            const recovered = e.checked ? "Y" : "N";
                            setvehiclesDetails({ ...vehiclesDetails, recovered });
                            setrecovered(e.checked);
                        }}
                        checked={recovered}
                    ></Checkbox>
                    <label>Recovered?</label>
                </div>
                {vehiclesDetails?.recovered === "Y" ? (
                    <div className="p-field p-col-12 p-md-3 p-pr-6">
                        <label>Recovered by</label>
                        <InputText
                            disabled={viewmode}
                            value={vehiclesDetails?.recoveredby}
                            onChange={(e) => {
                                setvehiclesDetails({ ...vehiclesDetails, recoveredby: e.target.value });
                            }}
                            placeholder="Recovered by"
                        />
                    </div>
                ) : (
                    <div className="p-field p-col-12 p-md-3"></div>
                )}
                ...
                <div className="p-field p-col-12 p-md-3 p-d-flex p-mt-4 p-pl-6">
                    <Checkbox
                        ...
                        value="Y"
                        onChange={(e) => {
                            const instorage = e.checked ? "Y" : "N";
                            setvehiclesDetails({ ...vehiclesDetails, instorage });
                            setinstorage(e.checked);
                        }}
                        checked={instorage}
                    ></Checkbox>
                    <label>In Storage?</label>
                </div>
                {vehiclesDetails?.instorage === "Y" ? (
                    <div className="p-field p-col-12 p-md-3 p-pr-6">
                        <label>Stored at</label>
                        <InputText
                            disabled={viewmode}
                            value={vehiclesDetails?.storage}
                            onChange={(e) => {
                                setvehiclesDetails({ ...vehiclesDetails, storage: e.target.value });
                            }}
                ...
                <div className="p-field p-col-12 p-md-4">
                    ...
                    <Dropdown
                        disabled={viewmode}
                        value={{ name: vehiclesDetails?.policycover }}
                        options={[{ name: "Fully Comprehensive" }, { name: "TP Only" }, { name: "TP Fire And Theft" }]}
                        onChange={(e) => {
                            setvehiclesDetails({ ...vehiclesDetails, policycover: e.value.name });
                        }}
                        placeholder="Select"
                        optionLabel="name"
                    />
                ...
                <div className="p-field p-col-12 p-md-4">
                    ...
                    <InputText
                        disabled={viewmode}
                        value={vehiclesDetails?.policyholder}
                        onChange={(e) => {
                            setvehiclesDetails({ ...vehiclesDetails, policyholder: e.target.value });
                        }}
