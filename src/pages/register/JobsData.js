  ...
  return (
    <div className="datatable-filter-demo">
      <div className="card p-datatable-sm">
        {console.log("companyJobsData row :: ", jobsData)}
        <DataTable
          ref={dt}
          value={jobsData}
          paginator
        ...
        >
          ...
          <Column
            field="childfee"
            header="Child Fee"
            body={childfeeBodyTemplate}
            filter
            sortable
          />
          <Column
            field="scotadultfee"
            header="Scot Adult Fee"
            body={scotadultfeeBodyTemplate}
            filter
            sortable
          />
          <Column
            field="scotchildfee"
            header="Scot Child Fee"
            body={scotchildfeeBodyTemplate}
            filter
            sortable
          />
          <Column
