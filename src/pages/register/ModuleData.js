    ...
    const statusBodyTemplate = (rowData) => {
        return (
            <React.Fragment>
                ...
                {rowData.modulestatus === "Y" ? <Badge value="Active" severity="success" className="p-mr-2"></Badge> : <Badge value="Inactive" severity="warning" className="p-mr-2"></Badge>}
            </React.Fragment>
        );
    };
        ...
        <div className="datatable-filter-demo">
            <div className="card p-datatable-sm">
                <DataTable ref={dt} value={usersData} paginator rows={10} className="p-datatable-customers" emptyMessage="No customers found.">
                    <Column style={{ textAlign: "center" }} field="modulename" header="Name" body={nameBodyTemplate} filter sortable   filterMatchMode="contains"/>
                    ...
                    <Column style={{ textAlign: "center" }} field="modulestatus" header="Status" body={statusBodyTemplate} filter sortable  filterMatchMode="contains" />
