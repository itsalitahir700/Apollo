...
const UsersData = () => {
    ...
    const companyUsersData = useSelector((state) => state.profileSlice.usersFreshData);
        ...
        <div className="datatable-filter-demo">
            <div className="card p-datatable-sm">
                <DataTable ref={dt} value={usersData} paginator rows={10} className="p-datatable-customers" emptyMessage="No customers found.">
                    <Column style={{ textAlign: "center" }} field="loginid" header="User Name" body={userfeeBodyTemplate} filter sortable />
